...
class App extends Component {
  ...
  render() {
    const {score, time, isGameRunning, activeTab, matchImage} = this.state
      ...
      <div className="app">
        ...
        {isGameRunning ? (
          <div className="game-section">
            <img src={matchImage.imageUrl} alt="match" className="main-image" />
              ...
              {filteredImages.map(image => (
                <li key={image.id}>
                  <button
                    ...
                    onClick={() => this.onThumbnailClick(image.id)}
                  >
                    <img
